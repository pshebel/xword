...
// NewXwordAPI creates a new Xword instance
func NewXwordAPI(spec *loads.Document) *XwordAPI {
	return &XwordAPI{
		...
		XwordGetXwordHandler: xword.GetXwordHandlerFunc(func(params xword.GetXwordParams) middleware.Responder {
			return middleware.NotImplemented("operation xword.GetXword has not yet been implemented")
		}),
		WordPostWordHandler: word.PostWordHandlerFunc(func(params word.PostWordParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation word.PostWord has not yet been implemented")
		}),
		XwordPostXwordHandler: xword.PostXwordHandlerFunc(func(params xword.PostXwordParams) middleware.Responder {
			return middleware.NotImplemented("operation xword.PostXword has not yet been implemented")
		}),
		...
		XwordSolvePutXwordSolvePuzzleHandler: xword_solve.PutXwordSolvePuzzleHandlerFunc(func(params xword_solve.PutXwordSolvePuzzleParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation xword_solve.PutXwordSolvePuzzle has not yet been implemented")
		}),
...
func (o *XwordAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *XwordAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *XwordAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *XwordAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *XwordAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *XwordAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *XwordAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the XwordAPI
func (o *XwordAPI) Validate() error {
...
func (o *XwordAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *XwordAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
...
func (o *XwordAPI) Authorizer() runtime.Authorizer {
	return o.APIAuthorizer
}

// ConsumersFor gets the consumers for the specified media types.
// MIME type parameters are ignored here.
func (o *XwordAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
// MIME type parameters are ignored here.
func (o *XwordAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *XwordAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the xword API
func (o *XwordAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *XwordAPI) initHandlerCache() {
...
func (o *XwordAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *XwordAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *XwordAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
	o.customProducers[mediaType] = producer
}

// AddMiddlewareFor adds a http middleware to existing handler
func (o *XwordAPI) AddMiddlewareFor(method, path string, builder middleware.Builder) {
	um := strings.ToUpper(method)
	if path == "/" {
		path = ""
	}
